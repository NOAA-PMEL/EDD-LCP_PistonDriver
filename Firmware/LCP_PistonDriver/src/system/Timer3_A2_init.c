...
{
    /* USER CODE START (section: Timer3_A2_Init_prologue) */
    /* User initialization code */
    /* USER CODE END (section: Timer3_A2_Init_prologue) */
    ...
    /* USER CODE START (section: Timer3_A2_Init_epilogue) */
    /* User code */
    /* USER CODE END (section: Timer3_A2_Init_epilogue) */
}
