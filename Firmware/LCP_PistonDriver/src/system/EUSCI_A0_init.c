...
void EUSCI_A0_Init(void)
{
    ...
    /* USER CODE START (section: EUSCI_A0_Init_prologue) */
    /* User initialization code */
    /* USER CODE END (section: EUSCI_A0_Init_prologue) */
...
//    .clockPrescalar = 34,
    ...
    /* USER CODE START (section: EUSCI_A0_Init_epilogue) */
    /* User code */
    /* USER CODE END (section: EUSCI_A0_Init_epilogue) */
